(() => {
  ...
  const els = {
    ...
    connectAccountsGroup: $("#connectAccountsGroup"),
    connectYoutubeBtn: $("#connectYoutubeBtn"),
    ...
    postToYoutubeLinkCta: $("#postToYoutubeLinkCta"),
    postToTiktokLinkCta: $("#postToTiktokLinkCta"),
    postToYoutubeToggle: $("#postToYoutubeToggle"),
    postToTiktokToggle: $("#postToTiktokToggle"),
    sidebar: $("#sidebar"),
